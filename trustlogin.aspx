...
<div class="form-style-8">
  <h2>Welcome !!! Login</h2>
     ...
     <asp:TextBox ID="TextBox1" runat="server" Width="100%" Height="30px" placeholder="User Name" ValidationGroup="trust"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="TextBox1" ValidationGroup="trust"></asp:RequiredFieldValidator>
     ...
     <asp:TextBox ID="TextBox2" runat="server" Width="100%" Height="30px" placeholder="Password" ValidationGroup="trust" TextMode="Password"></asp:TextBox>
    ...
    <br/>
 <a href="trust.aspx">Click Here To Trust Register</a>
</div>
    </form>
</body>
</html>
