...
<div id="content">
  <div class="home">
   ...
   <tr>
   <td>
       <asp:Button ID="Button1" runat="server" Text="View Public Food Details" BackColor="White" 
   ...
   <tr>
   <td>
         <%--<asp:Button ID="Button2" runat="server" Text="View Hotel Food Details" BackColor="White" 
