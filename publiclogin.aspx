<%@ Page Language="C#" AutoEventWireup="true" CodeFile="publiclogin.aspx.cs" Inherits="publiclogin" %>
...
<div class="form-style-8">
  <h2>Welcome !!! New Login</h2>

     <asp:TextBox ID="TextBox1" runat="server" Width="500px" Height="30px" 
                placeholder="Enter ur Email Id" ValidationGroup="trust" 
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="TextBox1" ValidationGroup="trust"></asp:RequiredFieldValidator>
     ...
     <br/>
  <a href="login.aspx">Already Register Click Here</a>
</div>
</form>
</body>
</html>
