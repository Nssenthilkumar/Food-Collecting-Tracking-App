<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trustrequest.aspx.cs" Inherits="trustrequest" %>
...
<script language="javascript" type="text/javascript">
   function view(id)
  {
   location.href='trustrequest.aspx?id='+id;
  }
  </script>
</head>
 ...
 <a href="othersrequest.aspx"> Request</a>
  ...
  <div>
   ...
   <%-- <ul>
      ...
      <li class="current"><a href="trustrequest.aspx">Trust Request</a></li>
