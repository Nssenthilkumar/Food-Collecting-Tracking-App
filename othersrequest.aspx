<%@ Page Language="C#" AutoEventWireup="true" CodeFile="othersrequest.aspx.cs" Inherits="othersrequest" %>
...
<div id="content">
  <div class="home">
   ...
   <tr>
   <td>
       <asp:Button ID="Button1" runat="server" Text="Public Request" BackColor="White" 
           Font-Bold="true" ForeColor="DarkGreen" Width="203px" Height="30px" 
           onclick="Button1_Click"/>
   </td>
   </tr>
   <tr>
   <td>
         <asp:Button ID="Button2" runat="server" Text="Hotel Request" BackColor="White" 
             Font-Bold="true" ForeColor="DarkGreen" Width="201px" Height="30px" 
