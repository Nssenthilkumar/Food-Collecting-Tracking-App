<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trustviewhotelrequest.aspx.cs" Inherits="trustviewhotelrequest" %>
...
<script language="javascript" type="text/javascript">
   function view(id)
  {
   location.href='trustviewhotelrequest.aspx?id='+id;
  }
   function view1(id1)
  {
   location.href='trustviewhotelrequest1.aspx?id1='+id1;
  }
  </script>
</head>
       ...
       PageSize="5" onselectedindexchanged="GridView1_SelectedIndexChanged1" 
         ...
         style="width: 433px; " 
            ...
            <RowStyle HorizontalAlign="Center" BackColor="White"/>
             ...
             <asp:BoundField DataField="hotelphoneno" HeaderText="Phoneno"/>
