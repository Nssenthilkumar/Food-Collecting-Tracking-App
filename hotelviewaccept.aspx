<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hotelviewaccept.aspx.cs" Inherits="hotelviewaccept" %>
...
<div id="content">
  <div class="home">
    <div class="aside">
      ...
      <div class="form-style-8">  <h2> Accept Details</h2>
            ...
            <RowStyle HorizontalAlign="Center" BackColor="White"/>
                <Columns>
                     ...
                     <asp:BoundField DataField="personname" HeaderText="Person Name"/>
                         <asp:BoundField DataField="trustphoneno" HeaderText="Phoneno"/>
            <asp:BoundField DataField="trustaddress" HeaderText="Address"/>
           <asp:BoundField DataField="status" HeaderText="Status"/>
            <asp:BoundField DataField="requestdate" HeaderText="Send Date"/>
                        <asp:BoundField DataField="acceptdate" HeaderText="Accept Date"/>
                 </Columns>
